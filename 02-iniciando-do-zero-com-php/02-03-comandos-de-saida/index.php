...
echo "<p>$hello</p>"; // sempre utilizar aspas duplas
echo '<p>$hello</p>';

$day = "dia";
echo "<p>Falta 1 $day para o evento!</p>";
echo "<p>Faltam 2 {$day}s para o evento!</p>"; // melhor padrão
...
<h4><?= $hello; ?> <?= $code; ?></h4> <!-- tag short do echo -->
...
$title = "{$hello} {$code}";
$subtitle = "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque dolore deserunt fugit ab nemo exercitationem voluptas fuga tempore iure, quidem amet officia nostrum esse cumque, sit deleniti corrupti sequi in!";
